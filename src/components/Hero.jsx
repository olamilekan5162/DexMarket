const Hero = () => {
    return ( 
        <div className="flex flex-col w-full mt-[120px] items-center px-16">
            <h1 className="font-bold text-6xl sm: text-4xl">YOUR NUMBER ONE DECENTRALIZED EXCHANGE MARKET</h1>
            <h1 className="font-bold mt-4 text-6xl text-blue-700 sm: text-4xl">DEXMARKET</h1>
